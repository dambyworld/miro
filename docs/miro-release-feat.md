...
| `update-tap` | `Ruska-Zone/homebrew-tap` Formula/miro.rb 자동 갱신 |
...
| `TAP_GITHUB_TOKEN` | `Ruska-Zone/homebrew-tap` 쓰기 권한 PAT (수동 등록 필요) |
...
### `Ruska-Zone/homebrew-tap` — `Formula/miro.rb`

- 저장소: https://github.com/Ruska-Zone/homebrew-tap
...
- [x] `brew install Ruska-Zone/tap/miro` 오류 없이 완료
...
- Tap 저장소: https://github.com/Ruska-Zone/homebrew-tap
